...
module.exports = async function router(app) {
       ...
       symbol= symbol.toUpperCase();
        ...
        User.findById(user).then((result)=>{
            ...
            soldShare.map((soldShare)=>{
                ...
                let current_data = async () => await axios.get(`/quote/:${symbole}`);
                console.log(current_data());
                //res.send('in progress',current_data);
                // let price = Rate*volume_bought;
    ...
    app.post('/edit', isAuth, urlencoded, (req, res, next) => {
    ...
    app.post('/delete', isAuth, urlencoded, (req, res, next) => {
